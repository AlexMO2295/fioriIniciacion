		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "prueba dos",
									"targetURL": "#prueba2prueba2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"prueba2prueba2-display": {
								"semanticObject": "prueba2prueba2",
								"action": "display",
								"description": "A Fiori application. prueba 2",
								"title": "prueba dos",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=prueba2.prueba2",
									"url": sap.ui.require.toUrl("prueba2/prueba2")
								}
							}
						}
					}
